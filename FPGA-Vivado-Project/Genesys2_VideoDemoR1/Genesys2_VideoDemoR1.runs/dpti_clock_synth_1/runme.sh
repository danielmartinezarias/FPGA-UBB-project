...
HD_PWD='C:/Users/danie/Dropbox/physics/UdeC/FPGA_UBB/Final_FPGA_UBB/Genesys2_VideoDemoR1/Genesys2_VideoDemoR1.runs/dpti_clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dpti_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dpti_clock.tcl
