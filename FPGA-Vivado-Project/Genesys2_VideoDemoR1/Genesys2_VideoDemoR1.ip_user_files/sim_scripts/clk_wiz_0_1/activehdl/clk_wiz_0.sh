...
#
# Script generated by Vivado on Wed Sep 20 15:27:56 -0300 2023
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/danie/Dropbox/physics/FPGA_UBB/Final_FPGA_UBB/Genesys2_VideoDemoR1/Genesys2_VideoDemoR1.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
