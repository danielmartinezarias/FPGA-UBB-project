...
#
# Script generated by Vivado on Thu Jan 25 12:03:37 +0100 2024
...
#
# Usage        : MemTx_1.sh
#                MemTx_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MemTx_1.sh [-reset_run]
#                MemTx_1.sh [-reset_log]
#                MemTx_1.sh [-help]
#
...
#                script (type 'MemTx_1.sh -help' for more information).
#
...
# script info
echo -e "MemTx_1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MemTx_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.MemTx_1 xil_defaultlib.glbl -o MemTx_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./MemTx_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key MemTx_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc MemTx_1_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MemTx_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MemTx_1.sh [-help]\n\
Usage: MemTx_1.sh [-step]\n\
Usage: MemTx_1.sh [-lib_map_path]\n\
Usage: MemTx_1.sh [-reset_run]\n\
Usage: MemTx_1.sh [-reset_log]\n\
Usage: MemTx_1.sh [-keep_index]\n\
Usage: MemTx_1.sh [-noclean_files]\n\n\
